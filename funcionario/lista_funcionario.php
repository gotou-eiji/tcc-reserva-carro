    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        while ($result = mysqli_fetch_assoc($query)) {
            ...
            echo '<tr>
                    ...
                    <td>
                        <a href="../funcionario/form_editar.php?idfuncionario=' . $result["idfuncionario"] . '&nome=' . $result["nome"] .'&cpf=' . $result["cpf"] .'&email=' . $result["email"] .'&telefone=' . $result["telefone"] .'&funcao=' . $result["funcao"] .'&emprego=' . $result["emprego"] .'&data_nascimento=' . $result["data_nascimento"] .'&cep=' . $result["cep"] . '&numero=' . $result["numero"] . '&complemento=' . $result["complemento"] . '&sexo=' . $result["sexo"] . '">
